...
const STYLE_EXECUTION = {
  ...
  photography:
    'real-world botanical/editorial photography, crisp detail, one hero focal subject in focus with soft background blur, natural imperfections and slight asymmetry, flat scene composition rendered as 2D print art, never product photo or physical arrangement, no CGI/plastic look, no glow, no fantasy lighting',
  'Abstract art':
    'gallery-style abstract print in the language of Bauhaus, mid-century modern and paper cut-outs: FLAT opaque shapes with clean hard edges—circles, arcs, rectangles, soft organic forms—resting on a calm textured ground of paper, plaster or raw canvas. Restrained palette of two to four muted colours (terracotta, ochre, sage, cream, ink, dusty blue) plus the ground. Generous quiet space around the forms is REQUIRED—the composition breathes and only a few elements carry it. Visible material texture: paper grain, dry brush, screen-print grit, slight registration offset. Strictly FLAT and two-dimensional: no gradients blending across the sheet, no 3D shading or volume, no glossy or metallic surfaces, no swirling ribbons, no glow, no photorealism, no busy patterns. The textured ground covers the whole sheet edge to edge, but the shapes themselves must NOT fill it',
  'abstract art':
    'gallery-style abstract print in the language of Bauhaus, mid-century modern and paper cut-outs: FLAT opaque shapes with clean hard edges—circles, arcs, rectangles, soft organic forms—resting on a calm textured ground of paper, plaster or raw canvas. Restrained palette of two to four muted colours (terracotta, ochre, sage, cream, ink, dusty blue) plus the ground. Generous quiet space around the forms is REQUIRED—the composition breathes and only a few elements carry it. Visible material texture: paper grain, dry brush, screen-print grit, slight registration offset. Strictly FLAT and two-dimensional: no gradients blending across the sheet, no 3D shading or volume, no glossy or metallic surfaces, no swirling ribbons, no glow, no photorealism, no busy patterns. The textured ground covers the whole sheet edge to edge, but the shapes themselves must NOT fill it',
  Abstract:
    'gallery-style abstract print in the language of Bauhaus, mid-century modern and paper cut-outs: FLAT opaque shapes with clean hard edges—circles, arcs, rectangles, soft organic forms—resting on a calm textured ground of paper, plaster or raw canvas. Restrained palette of two to four muted colours (terracotta, ochre, sage, cream, ink, dusty blue) plus the ground. Generous quiet space around the forms is REQUIRED—the composition breathes and only a few elements carry it. Visible material texture: paper grain, dry brush, screen-print grit, slight registration offset. Strictly FLAT and two-dimensional: no gradients blending across the sheet, no 3D shading or volume, no glossy or metallic surfaces, no swirling ribbons, no glow, no photorealism, no busy patterns. The textured ground covers the whole sheet edge to edge, but the shapes themselves must NOT fill it',
