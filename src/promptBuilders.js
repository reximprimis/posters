...
const STYLE_LOGIC_MAP = {
  ...
  'Monet Style':
    'Original painting in the tradition of French impressionist light studies — soft feathery brushstrokes, dissolved edges, shimmering reflected light on water or foliage, a hazy atmospheric quality built from small broken touches of color rather than blended paint, gentle pastel-to-vivid harmony, tranquil garden or waterside mood. An original composition inspired by this painterly technique, not a reproduction of any specific existing artwork. No text, no signature, no watermark within the artwork itself.',
  'Klimt Style':
    'Original painting in the tradition of Viennese Art Nouveau ornamental symbolism — flat decorative passages of gold and jewel-tone color built from intricate mosaic-like patterning (spirals, small geometric tiles, organic swirls), rich gilded warmth contrasted with naturalistic detail in the subject itself, dense surface ornamentation used as background and framing rather than empty space. Applied only to natural/botanical subject matter, never to human figures or faces. An original composition inspired by this decorative technique, not a reproduction of any specific existing artwork. No text, no signature, no watermark within the artwork itself.',
  'Matisse Style':
    'Original painting in the tradition of Fauvist bold color and decorative simplification — flat unmodulated areas of vivid, non-naturalistic color, confident simplified shapes with minimal internal detail, rhythmic decorative pattern, joyful high-contrast color pairings placed directly against each other. An original composition inspired by this painterly technique, not a reproduction of any specific existing artwork. No text, no signature, no watermark within the artwork itself.',
};
