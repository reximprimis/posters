...
const CATEGORY_TITLE_POOLS = {
  'botanical': [
    ...
    'Dandelion Seed Ball',
    'Comfrey Root Drawing',
    'Elderflower Umbel',
    'Sycamore Seed Wing',
    'Hawthorn Berry Spray',
    'Cowslip Cluster Yellow',
    'Beech Nut Husk',
    'Meadowsweet Froth',
    'Burdock Bur Hook',
    'Sundew Sticky Trap',
  ...
  'animals': [
    ...
    'Bee on Clover',
    'Swallowtail Wing Pattern',
    'Ground Beetle Carapace',
    ...
    'Snail Shell Spiral',
    'Ladybird Elytra',
    'Grasshopper Leg Study',
    'Bullfinch Pair Plate',
    'Common Frog Study',
    'Newt Belly Pattern',
    'Sparrow Dust Bath',
    'Mistle Thrush Plate',
    'Hoverfly Mimic Study',
    'Woodlouse Segments',
  ...
  'kitchen-food': [
    ...
    'Damson Plum Branch',
    'Cherry Variety Plate',
    'Gooseberry Branchlet',
    'Chestnut Burr Open',
  ],
  'architecture': [
  ...
  'sea-coast': [
    ...
    'Anchor Chain Links',
    'Scallop Shell Fan',
    'Nautilus Chamber Section',
    'Coral Branch Specimen',
    'Seaweed Frond Pressed',
    'Limpet Cone Cluster',
  ],
  ...
  'maps': [
    'World Map Muted Tones',
    'Vintage Nautical Chart',
    'Antique World Map Sepia',
    'Ocean Currents Chart',
    'Ancient Trade Routes Map',
    'Historic Empire Territories Map',
    ...
    'City Grid Vienna',
    'City Grid Amsterdam',
    'Mountain Range Elevation Map',
    'Coastal Survey Chart',
    'River Basin Cartography',
    'Star Chart Northern Sky',
    'Continental Drift Diagram',
    'Wind Rose Compass',
    'Harbor Depth Soundings',
    'Railway Network Map',
    'Medieval Trade Map',
    "Explorer's Route Chart",
    'Archipelago Survey Map',
  ...
  'typography-quotes': [
    ...
    'Today Is Enough',
    'Gather Here Lettering',
    'Warm Light Words',
    'Stay Curious Type',
    'Slow Down Script',
    'Gentle Reminder Words',
    'Make It Happen Type',
    'Present Moment Lettering',
    'Soft Focus Words',
    'Trust The Process Type',
    'Golden Hour Lettering',
  ],
  'mountains-hiking': [
  ...
  'line-art-figures': [
    ...
    'Folded Arms Contour',
    'Bent Knee Study',
    'Crossed Legs Contour',
    'Hand On Chin',
    'Two Bodies Overlap',
    'Standing Figure Line',
    'Curled Sleeping Form',
    'Arm Raised Curve',
    'Mirror Pose Study',
    'Kneeling Figure Line',
    'Twisted Pose Study',
  ],
  'bar-cocktails': [
    ...
    'Copper Jigger Shine',
    'Rum And Lime Still',
    'Absinthe Spoon Ritual',
    'Bar Cart Vintage',
    'Smoked Glass Cocktail',
    'Tiki Mug Detail',
    'Wine Glass Silhouette',
    'Bitters Dash Motion',
    'Copper Mule Mug',
    'Sherry Cask Pour',
    'Bartender Hands Motion',
  ],
  'zodiac-astrology': [
    ...
    'Planetary Orbit Chart',
    'Tarot Star Card',
    'Zodiac Elements Wheel',
    'Natal Chart Wheel',
    'Eclipse Path Diagram',
    'Rising Sign Chart',
