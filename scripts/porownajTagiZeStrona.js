...
for (const m of csv.matchAll(/\b(category|style|aesthetic|room|color|occasion|collection|orientation|size|set|gallery-set|wall|framed-gallery-set|frame-color|frame-material|badge):([a-z0-9-]+)/g)) {
  const t = m[1] + ':' + m[2];
